...
module.exports = {
  ...
  ticketsReservation: async function (page, row, ...chairs) {
    ...
    try {
      ...
      throw new Error(`Chairs are occupated`);
    }
  ...
  checkIfChairsAreReserved: async function (page, row, ...chairs) {
    ...
    try {
      ...
      throw new Error("Chairs are available");
    }
  },
  ...
  getText: async function (page, selector) {
    try {
      ...
      throw new Error(`Text does not fit selector: ${selector}`);
    }
  },
  ...
  putText: async function (page, selector, text) {
    try {
      ...
      throw new Error(`Text for selector is not available: ${selector}`);
    }
  },
};
